...
while(True):
    ...
    frcoy.append(yf)
    # print("frcox: ", frcox[i])                                            
    # print("frcox: ", frcox[i-1])                                            

    if (frcox[i]==frcox[i-1]) & (frcoy[i]==frcoy[i-1]):
        cv2.putText(frame_left, "Static Face", (75,100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255),2)
        cv2.putText(frame_right, "Static Face", (75,100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255),2)

    else:
        cv2.putText(frame_left, "Moving Face", (75,100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255),2)
        cv2.putText(frame_right, "Static Face", (75,100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255),2)
    ...
    cv2.circle(frame_right, circles_right, 5, (255, 255, 0), -1)
